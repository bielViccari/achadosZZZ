                    ...
                    <div class="grid  gap-8 grid-cols-1">
                        <div class="flex flex-col ">
                            <div class="flex flex-col sm:flex-row items-center">
                                <h2 class="font-semibold text-lg mr-auto">Cadastrar produto</h2>
                                ...
                                <div class="form">
                                    <div class="md:space-y-2 mb-3">
                                        ...
                                        <div class="flex items-center py-6">
                                            <div class="w-12 h-12 mr-4 flex-none rounded-xl border overflow-hidden">
                                                <img id="oldImage" class="w-12 h-12 mr-4 object-cover"
                                    ...
                                    <div class="flex-auto w-full mb-1 text-xs space-y-2">
                                        ...
                                        <textarea required="" name="description" id="description"
                                            ...
                                            placeholder="Coloque as Informações do produto" spellcheck="false"></textarea>
                                    ...
                                    <p class="text-xs text-red-500 text-right my-3">Campos obrigatórios estarão marcados
                                        com <abbr title="Required field"> * </abbr></p>
